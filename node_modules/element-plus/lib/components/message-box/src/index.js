...
const _sfc_main = vue.defineComponent({
  ...
  emits: ["vanish", "action"],
  setup(props, { emit }) {
    const { locale, zIndex, ns } = useGlobalConfig.useGlobalComponentSettings("message-box");
    const { t } = locale;
    ...
    const btnSize = useFormCommonProps.useFormSize(vue.computed(() => props.buttonSize), { prop: true, form: true, formItem: true });
