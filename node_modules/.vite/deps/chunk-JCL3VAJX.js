...
import { useDocumentVisibility, useWindowFocus, useResizeObserver as useResizeObserver2 } from "@vueuse/core";
...
var TabBar = _export_sfc(_sfc_main, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tabs/src/tab-bar.vue"]]);
...
var TabNav = defineComponent({
  ...
  setup(props, {
    ...
    const rootTabs = inject(tabsRootContextKey);
    if (!rootTabs)
      throwError(COMPONENT_NAME2, `<el-tabs><tab-nav /></el-tabs>`);
    const ns = useNamespace("tabs");
...
var _sfc_main2 = defineComponent({
  ...
  setup(__props) {
    ...
    if (!tabsRoot)
      throwError(COMPONENT_NAME3, "usage: <el-tabs><el-tab-pane /></el-tabs/>");
...
var TabPane = _export_sfc(_sfc_main2, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tabs/src/tab-pane.vue"]]);
...
//# sourceMappingURL=chunk-JCL3VAJX.js.map
