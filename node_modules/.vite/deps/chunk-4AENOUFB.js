...
import { isClient as isClient3 } from "@vueuse/core";

// node_modules/element-plus/es/utils/dom/style.mjs
import { isClient as isClient2, isNumber as isNumber3 } from "@vueuse/core";
...
import { isBoolean as isBoolean2, isNumber as isNumber2 } from "@vueuse/core";
...
var getStyle = (element, styleName) => {
  var _a;
  if (!isClient2 || !element || !styleName)
    return "";
...
var globalNodes = [];
var target = !isClient4 ? void 0 : document.body;
...
var isFirefox = () => isClient5 && /firefox/i.test(window.navigator.userAgent);

// node_modules/element-plus/es/utils/i18n.mjs
var isKorean = (text) => /([(\uAC00-\uD7AF)|(\u3130-\u318F)])+/gi.test(text);

// node_modules/element-plus/es/utils/raf.mjs
import { isClient as isClient6 } from "@vueuse/core";
var rAF = (fn2) => isClient6 ? window.requestAnimationFrame(fn2) : setTimeout(fn2, 16);
var cAF = (handle) => isClient6 ? window.cancelAnimationFrame(handle) : clearTimeout(handle);
...
import { isBoolean as isBoolean3, isNumber as isNumber4 } from "@vueuse/core";
...
import { isClient as isClient7 } from "@vueuse/core";
var useLockscreen = (trigger) => {
  ...
  if (!isClient7 || hasClass(document.body, hiddenCls.value)) {
    return;
  }
...
import { isClient as isClient8, useEventListener } from "@vueuse/core";
var modalStack = [];
var closeModal = (e) => {
...
import { isClient as isClient9, isBoolean as isBoolean4 } from "@vueuse/core";
var _prop = buildProp({
  ...
  const useModelToggle2 = ({
    ...
    const show = (event) => {
      if (props.disabled === true || isFunction(shouldProceed) && !shouldProceed())
        return;
      const shouldEmit = hasUpdateHandler.value && isClient9;
      if (shouldEmit) {
    ...
    const hide2 = (event) => {
      if (props.disabled === true || !isClient9)
        return;
      const shouldEmit = hasUpdateHandler.value && isClient9;
      if (shouldEmit) {
...
import { useEventListener as useEventListener2 } from "@vueuse/core";
var usePreventGlobal = (indicator, evt, cb) => {
  ...
  watch(() => indicator.value, (val) => {
    if (val) {
      stop = useEventListener2(document, evt, prevent, true);
    } else {
...
import { isClient as isClient10 } from "@vueuse/core";
...
import { isClient as isClient11 } from "@vueuse/core";
...
var useId = (deterministicId) => {
  ...
  if (!isClient11 && idInjection === defaultIdInjection) {
...
import { isClient as isClient12 } from "@vueuse/core";
...
import { isClient as isClient13 } from "@vueuse/core";
var cachedContainer;
...
import { isNumber as isNumber5 } from "@vueuse/core";
var zIndex = ref(0);
...
var useZIndex = () => {
  ...
  const initialZIndex = computed2(() => {
    ...
    return isNumber5(zIndexFromInjection) ? zIndexFromInjection : defaultInitialZIndex;
  });
...
import { isClient as isClient14, unrefElement } from "@vueuse/core";
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4AENOUFB.js.map
